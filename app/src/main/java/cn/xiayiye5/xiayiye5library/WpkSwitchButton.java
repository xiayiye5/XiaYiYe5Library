...
public class WpkSwitchButton extends CompoundButton {
    ...
    public WpkSwitchButton(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public WpkSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public WpkSwitchButton(Context context) {
        super(context);
        init(null);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, R.styleable.WpkSwitchButton);
        if (ta != null) {
            thumbDrawable = ta.getDrawable(R.styleable.WpkSwitchButton_kswThumbDrawable);
            thumbColor = ta.getColorStateList(R.styleable.WpkSwitchButton_kswThumbColor);
            margin = ta.getDimension(R.styleable.WpkSwitchButton_kswThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.WpkSwitchButton_kswThumbMarginLeft, margin);
            marginRight = ta.getDimension(R.styleable.WpkSwitchButton_kswThumbMarginRight, margin);
            marginTop = ta.getDimension(R.styleable.WpkSwitchButton_kswThumbMarginTop, margin);
            marginBottom = ta.getDimension(R.styleable.WpkSwitchButton_kswThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(R.styleable.WpkSwitchButton_kswThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(R.styleable.WpkSwitchButton_kswThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(R.styleable.WpkSwitchButton_kswThumbRadius, thumbRadius);
            backRadius = ta.getDimension(R.styleable.WpkSwitchButton_kswBackRadius, backRadius);
            backDrawable = ta.getDrawable(R.styleable.WpkSwitchButton_kswBackDrawable);
            backColor = ta.getColorStateList(R.styleable.WpkSwitchButton_kswBackColor);
            thumbRangeRatio = ta.getFloat(R.styleable.WpkSwitchButton_kswThumbRangeRatio, thumbRangeRatio);
            animationDuration = ta.getInteger(R.styleable.WpkSwitchButton_kswAnimationDuration, animationDuration);
            fadeBack = ta.getBoolean(R.styleable.WpkSwitchButton_kswFadeBack, true);
            tintColor = ta.getColor(R.styleable.WpkSwitchButton_kswTintColor, tintColor);
            textOn = ta.getString(R.styleable.WpkSwitchButton_kswTextOn);
            textOff = ta.getString(R.styleable.WpkSwitchButton_kswTextOff);
            textThumbInset = ta.getDimensionPixelSize(R.styleable.WpkSwitchButton_kswTextThumbInset, 0);
            textExtra = ta.getDimensionPixelSize(R.styleable.WpkSwitchButton_kswTextExtra, 0);
            textAdjust = ta.getDimensionPixelSize(R.styleable.WpkSwitchButton_kswTextAdjust, 0);
            ta.recycle();
        }
    ...
    private final int ENABLE_ATTR = android.R.attr.state_enabled;
    private final int CHECKED_ATTR = android.R.attr.state_checked;
    private final int PRESSED_ATTR = android.R.attr.state_pressed;

    private ColorStateList generateThumbColorWithTintColor(final int tintColor) {
        int[][] states = new int[][]{
    ...
    private ColorStateList generateBackColorWithTintColor(final int tintColor) {
        int[][] states = new int[][]{
                {-ENABLE_ATTR, CHECKED_ATTR},
                {-ENABLE_ATTR},
