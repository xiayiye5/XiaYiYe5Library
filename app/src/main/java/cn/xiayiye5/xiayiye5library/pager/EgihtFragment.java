 ...
 * 类描述 :
 */
public class EgihtFragment extends Fragment implements View.OnClickListener {

    private CurrentPage currentPage;

    public static Fragment getInstance(CurrentPage currentPage) {
        EgihtFragment oneFragment = new EgihtFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_egiht, container, false);
    }
