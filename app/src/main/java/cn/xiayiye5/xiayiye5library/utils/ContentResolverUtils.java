...
public abstract class ContentResolverUtils {
     ...
     * @param values 插入参数
     */
    public static Uri insert(Context context, Uri url,
     ...
     */
    public static int update(Context context, Uri uri,
     ...
     */
    public static int delete(Context context, Uri url, String where,
