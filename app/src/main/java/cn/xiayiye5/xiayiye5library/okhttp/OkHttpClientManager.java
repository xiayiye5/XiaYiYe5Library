package cn.xiayiye5.xiayiye5library.okhttp;
 ...
 * 翔哥的okhttp集成进来，方便以后调用
 * 使用方法：http://blog.csdn.net/lmj623565791/article/details/47911083
 * https相关：http://blog.csdn.net/lmj623565791/article/details/48129405
 */
public class OkHttpClientManager {
    ...
    public class PostDelegate {
        private final MediaType MEDIA_TYPE_STREAM = MediaType.parse(
        ...
        public void postAsyn(String url, File bodyFile, final ResultCallback callback) {
            postAsyn(url, bodyFile, MediaType.parse("application/octet-stream;charset=utf-8"),
                callback);
        }
        ...
        public void postAsyn(String url, byte[] bodyBytes, final ResultCallback callback) {
            postAsyn(url, bodyBytes, MediaType.parse("application/octet-stream;charset=utf-8"),
                callback);
        }
    ...
    public class UploadDelegate {
         ...
         */
        public Response post(String url, String[] fileKeys, File[] files, Param[] params)
            throws IOException {
         ...
         * 同步单文件上传
         */
        public Response post(String url, String fileKey, File file, Param... params)
            throws IOException {
    ...
    public class HttpsDelegate {
        ...
        public class MyTrustManager implements X509TrustManager {
            ...
            public MyTrustManager(X509TrustManager localTrustManager)
                ...
                TrustManagerFactory var4 = TrustManagerFactory.getInstance(
